...
@XmlRootElement(name = "headGesture")
public class HeadGesture {

    @XmlElement(required = true)
    protected String headGestureType;
    protected Double confidence;
    @XmlElement(name = "conf_str")
    protected String confStr;

    /**
     * Gets the value of the headGestureType property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getHeadGestureType() {
        return headGestureType;
    }

    /**
     * Sets the value of the headGestureType property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setHeadGestureType(String value) {
        this.headGestureType = value;
    }
