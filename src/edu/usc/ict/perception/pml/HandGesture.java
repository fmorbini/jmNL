...
@XmlRootElement(name = "handGesture")
public class HandGesture {

    @XmlElement(required = true)
    protected String handGestureType;
    protected Double confidence;
    @XmlElement(name = "conf_str")
    protected String confStr;

    /**
     * Gets the value of the handGestureType property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getHandGestureType() {
        return handGestureType;
    }

    /**
     * Sets the value of the handGestureType property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setHandGestureType(String value) {
        this.handGestureType = value;
    }
