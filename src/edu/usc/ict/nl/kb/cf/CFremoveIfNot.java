 ...
 */
public class CFremoveIfNot implements CustomFunctionInterface {
	...
	private static final String getNameFromClass() {
		return CFremoveIfNot.class.getSimpleName().toLowerCase().substring(2);
	}
	...
	public static void main(String[] args) throws Exception {
		CFremoveIfNot f = new CFremoveIfNot();
